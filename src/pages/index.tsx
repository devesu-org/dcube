...
const IndexPage: NextPage = () => {
  const onScroll = useCallback((event) => {
    ...
    if (scrollpos > 10) {
      ...
      navaction.classList.add(styles.gradient);
      ...
      navaction.classList.remove(styles.gradient);
  ...
  return (
    <div>
      <Head>
        ...
        <title>DCUBE Classes</title>
        <meta name="description" content="DCUBE Classes" />
        <meta name="keywords" content="DCUBE Classes" />
        ...
        <title>DCUBE Classes</title>
        <meta name="title" content="DCUBE Classes" />
        <meta name="description" content="DCUBE Classes" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tailwindtoolbox.com/" />
        <meta property="og:title" content="DCUBE Classes" />
        <meta property="og:description" content="DCUBE Classes" />
        <meta
          property="og:image"
          content="https://www.tailwindtoolbox.com/social.png"
        />

        <meta property="twitter:card" content="summary_large_image" />
        <meta
          property="twitter:url"
          content="https://www.tailwindtoolbox.com/"
        />
        <meta property="twitter:title" content="DCUBE Classes" />
        <meta property="twitter:description" content="DCUBE Classes" />
        <meta
      ...
      <div
        className={`leading-normal tracking-normal text-white ${styles.gradient}`}
      >
        <nav id="header" className="fixed top-0 z-30 w-full text-white">
          <div className="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between py-2">
            ...
            <div
              className="z-20 mt-2 hidden w-full flex-grow bg-white p-4 text-black lg:mt-0 lg:block lg:flex lg:w-auto lg:items-center lg:bg-transparent lg:p-0"
              id="nav-content"
            >
              ...
              <button
                id="navAction"
                className="mx-auto mt-4 rounded-full bg-white py-4 px-8 font-bold text-gray-800 opacity-75 shadow hover:underline lg:mx-0 lg:mt-0"
              >
                Action
              </button>
            </div>
          ...
          <div className="container mx-auto flex flex-col flex-wrap items-center px-3 md:flex-row">
            <div className="flex w-full flex-col items-start justify-center text-center md:w-2/5 md:text-left">
              <p className="tracking-loose w-full uppercase">
                A STATEMENT FROM LEADER
              </p>
              <h1 className="my-4 text-5xl font-bold leading-tight">
                We focus on Individual aspiration and prepare them to give their
                best to the society .
              </h1>
              ...
              <button className="mx-auto my-6 rounded-full bg-white py-4 px-8 font-bold text-gray-800 shadow-lg hover:underline lg:mx-0">
                Subscribe
              </button>
            </div>

            <div className="w-full p-6 text-center md:w-3/5">
              <img className="z-50 w-full md:w-4/5" src="/dcube_classes.jpeg" />
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 p-6 sm:w-1/2">
                ...
                <p className="mb-8 text-gray-600">
                  Our mission - To develop well rounded, confident and
            ...
            <div className="flex flex-col-reverse flex-wrap sm:flex-row">
              ...
              <div className="mt-6 w-full p-6 sm:w-1/2">
                <div className="align-middle">
                  ...
                  <p className="mb-8 text-gray-600">
                    To provide education while fostering each individual
                    intellectual, social, physical and moral development in an
        ...
        <section className="border-b bg-white py-8">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="mb-4 w-full">
              <div
                className={`mx-auto my-0 h-1 w-64 rounded-t py-0 opacity-25  ${styles.gradient}`}
              ></div>
            </div>

            <div className="flex w-full flex-shrink flex-grow flex-col p-6 md:w-1/4">
              <div className="flex-1 overflow-hidden rounded-t rounded-b-none bg-white pt-2 shadow">
                <a
                  href="#"
              ...
              <div className="mt-auto flex-none overflow-hidden rounded-b rounded-t-none bg-white p-6 shadow">
                <div className="flex items-center justify-start">
                  <button
                    className={`mx-auto my-6 rounded-full py-4 px-8 font-bold text-white shadow-lg hover:underline lg:mx-0  ${styles.gradient}`}
                  >
                    Action
                  </button>
                </div>
